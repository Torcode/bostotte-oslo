...
- `data/clean/forhandsanslag.csv` — daterte effektanslag per intervensjon (ni rader), skilt etter om anslaget er publisert *før* hendelsen, etterberegnet, eller utledet av regelmekanikken. Grunnlaget for modell M7, som pålegger effektstørrelsen der regressoren ikke kan estimeres. **Kjent hull, undersøkt:** høstpakken 2024 (I14/I15/I16) har ingen publiserte husstandstall. Gjennomsøkt 5.8.2026: Husbankens årsrapporter 2024 og 2025, Prop. 104 S (2023–2024), Husbankens pressemelding om revidert nasjonalbudsjett 2024, og Innst. 16 S (2024–2025). Alle oppgir kroner (85, 22 og 8 mill.), ingen oppgir husstander. Omregning fra kroner er ikke forsvarlig for oppvarmingstillegget, som gikk til eksisterende mottakere.
